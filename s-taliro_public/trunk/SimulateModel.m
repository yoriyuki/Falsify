...
% points.
%
% [T,XT,YT,InpSignal,LT,CLG,GRD,X0] = 
...
%                             locations
%
%          - X0           :   Initial conditions or other static parameters
%
% See also: staliro, staliro_options 

% (C) Georgios Fainekos 2012 - Arizona State University

function [T,XT,YT,InpSignal,LT,CLG,GRD,XPoint] = SimulateModel(InputModel,InitCond,InputRange,CPArray,Sample,TotT,opt)

...
disp([' 1. O(',Pred(1).str,') = Location {',num2str(Pred(1).loc),'} x {x in R^4 | x_1>=',num2str(-Pred(1).b(1)),' /\ x_2>=',num2str(-Pred(1).b(2)),'}']);
disp([' 2. O(',Pred(2).str,') = Location {',num2str(Pred(2).loc),'} x {x in R^4 | x_1<=',num2str(Pred(2).b(1)),' /\ x_2<=',num2str(Pred(2).b(2)),'}']);
disp([' 3. O(',Pred(3).str,') = Location {',num2str(Pred(3).loc),'} x {x in R^4 | x_1>=',num2str(-Pred(3).b(1)),' /\ x_2>=',num2str(-Pred(3).b(2)),'}']);

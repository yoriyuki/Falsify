...
for ii = 1:opt.runs
    ...
    opt_temp = opt;
    opt_temp.optimization_solver = params.optimization_solver;
    opt_temp.optim_params = params.optimization_params;
    [getResults, ~] = feval(params.optimization_solver,inpRanges,opt_temp);

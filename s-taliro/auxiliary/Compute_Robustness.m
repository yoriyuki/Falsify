...
if iscell(input)
    ...
    if (staliro_opt.stochastic == 1) && (staliro_opt.n_workers > 1)
        ...
        % multiple simulations (staliro_opt.n_stochastic_runs) will be returned using 
      	% staliro_opt.n_workers clusters.
        ...
        parfor (ii = 1:staliro_opt.n_stochastic_runs, staliro_opt.n_workers)
            warning('off','Simulink:Logging:LegacyModelDataLogsFormat');
